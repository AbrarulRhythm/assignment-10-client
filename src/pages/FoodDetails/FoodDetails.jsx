...
const FoodDetails = () => {
    ...
    const handleRequestFood = (requestData) => {
        const newRequestData = { ...requestData, requesterEmail: user?.email, requesterName: user?.displayName, requesterImage: user?.photoURL, donatorEmail: donatorEmail, donatorName: donatorName, donatorImage: donatorImage, foodId: _id, foodStatus: 'Pending' };
