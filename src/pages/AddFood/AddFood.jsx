                    ...
                    <div className='w-full md:w-11/12 lg:w-8/12 px-3'>
                        <div className='p-8 md:p-10 bg-white rounded-md border border-dark-04'>
                            <div className='text-center mb-6'>
                                <h1 className='text-[34px] font-semibold text-heading mb-2'>Add Food</h1>
                            </div>
                            ...
                            <form onSubmit={handleSubmit(handleAddFood)}>
                                <div className='flex flex-wrap -mx-3'>
                                    ...
                                    <div className='w-full px-3'>
                                        <button className='w-full button mt-4 l-r-b' disabled={isSubmitting}>{isSubmitting ? <span className='loading loading-spinner loading-sm'></span> : 'Add Food'}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
